...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: ' Tarea3_200570', // Título de la aplicación.
              ...
              children: <Widget>[
                Center(
                  child: Container(
                    ...
                    child: Text(
                      'TAREA 3 200570 :Estlizacion, Animaciones y uso de Fuentes',
                      style: TextStyle(
                        fontFamily:
                            'oswald', // Usa el nombre de tu fuente personalizada.
                ...
                Image.asset(
                  'assets/image/titanfall2.jpg', //  ruta de la imagen.
